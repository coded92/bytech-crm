...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-2xl border border-transparent bg-clip-padding text-sm font-semibold whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/35 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "bg-[var(--bytech-accent)] text-white shadow-lg shadow-indigo-200/60 hover:brightness-95",
        outline:
          "border-white/80 bg-white/90 text-[#111827] shadow-sm shadow-indigo-100 hover:bg-white hover:text-[#111827] aria-expanded:bg-white aria-expanded:text-[#111827] dark:border-input dark:bg-input/30 dark:hover:bg-input/50",
        secondary:
          "bg-[#F1F0FC] text-[#111827] hover:bg-indigo-100 aria-expanded:bg-indigo-100 aria-expanded:text-[#111827]",
        ghost:
          "hover:bg-white/80 hover:text-[#111827] aria-expanded:bg-white/80 aria-expanded:text-[#111827] dark:hover:bg-muted/50",
        destructive:
