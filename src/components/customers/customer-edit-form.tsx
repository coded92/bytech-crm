          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <CardDescription className="mt-1">
                Update customer account profile, billing terms, ownership, and lifecycle details.
              </CardDescription>
            </div>
            ...
            <fieldset disabled={isPending} className="space-y-6">
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    defaultValue={customer.account_manager_id ?? ""}
              ...
              >
                <div className="space-y-2">
                  ...
                  <select id="plan_type" name="plan_type" defaultValue={customer.plan_type ?? ""} className={selectClass}>
              ...
              >
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    type="date"
                    defaultValue={toDateInput(customer.onboarding_date)}
                    className={inputClass}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    name="go_live_date"
                    type="date"
                    defaultValue={toDateInput(customer.go_live_date)}
                    className={inputClass}
                  />
                </div>
              </FormSection>
              ...
              >
                ...
                <div className="space-y-2">
                  ...
                  <Input id="state" name="state" defaultValue={customer.state ?? ""} className={inputClass} />
                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Textarea
                    ...
                    className="rounded-2xl border-slate-200 bg-white/90 shadow-sm shadow-slate-100"
                  />
                </div>
